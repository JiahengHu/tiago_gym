...
from real_tiago.utils.ros_utils import Publisher, Listener, TFTransformListener
from real_tiago.utils.transformations import euler_to_quat, quat_to_euler, add_angles, quat_to_rmat
...
class TiagoArms:
    ...
    def process_action(self, action):
        ...
        # pos_delta, euler_delta = action[:3], np.zeros(3)
